...
void mainframeRoom::insertInteractions() {
    ...
    setName("MAINFRAME");
    setLongDescription("If NAVIGATION could be considered the mind of the space station, and the CAPTAIN'S CABIN \n"
                       "the soul, then this room, the MAINFRAME, is surely the heart. Normally off limits to all but \n"
                       "the most trusted of personnel, you feel a bit overwhelmed at the vast complexity before you. \n"
                       "Panels of switches stretch across the walls. However your eye is drawn to what looks like a \n"
                       "central COMPUTER terminal with a NOTE taped to the corner that appears to be functional. \n"
                       "Behind you lies the dark hall back to CORRIDOR 1.");
