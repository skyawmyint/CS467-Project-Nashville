...
electrical::electrical() : room(11)
{
    ...
    setLongDescription("There is the smell of burning ozone accompanied with a sizzling sound that makes your eardrums ring \n"
                       ...
                       "being quite dangerous to approach and causing the lights to flicker. In the corner however, safety out of range of the PANEL, \n"
                       "sits a COMPUTER on a desk that somehow seems to have power...you can always go back to CORRIDOR 1.");
